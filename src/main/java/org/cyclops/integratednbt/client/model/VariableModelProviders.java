...
public class VariableModelProviders {
    ...
    public static final SingleVariableModelProvider NBT_EXTRACTED = REGISTRY.addProvider(new SingleVariableModelProvider(Identifier.fromNamespaceAndPath(Reference.MOD_ID, "customoverlay/nbt_extracted")));
